...
/// </summary>
public static class EmailImprovedConsistency {
    public static void Create(bool openInBrowser = false) {
        ...
        var email = new Email()
            ...
            .ConfigureLayout(EmailLayoutSize.ExtraWide, EmailPaddingSize.Medium, EmailPaddingSize.Small); // Now using enums!
        ...
        email.Header.EmailRow(row => {
            ...
            row.EmailColumn(col => {
                col.SetWidth("30%").SetAlignment(Alignment.Right);
